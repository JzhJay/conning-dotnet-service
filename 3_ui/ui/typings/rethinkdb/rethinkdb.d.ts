...
declare module "rethinkdb" {
	...
	interface Table extends Sequence {
		...
		get(key: string | number): Sequence; // primary key
		getAll(key: string | number, index?: Index): Sequence; // without index defaults to primary key
		getAll(...keys: Array<string | number>): Sequence;
	}
