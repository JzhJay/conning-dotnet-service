...
interface HighchartsRendererObject {
    ...
    label(text:string, x: number, y: number, shape: string, anchorX: number, anchorY: number, useHTML?: boolean, baseline?: boolean, className?: string): HighchartsElementObject;
}
...
interface HighchartsStatic {
   ...
   charts: HighchartsChartObject[];
    ...
    color(color: string | HighchartsGradient): HighchartsGradient;

    addEvent(obj: any, functionName: string, fn: Function);
    ...
    each(array: any[], fn: Function): any;
    pick(prop:any, prop2:any): any;
    map(array: any[], fn: Function): any[];
    extend(obj:any, target:any);
}
...
interface HighchartsColumnMetricsObject {
	offset?: number,
	width?: number
}
...
interface HighchartsSeriesObject {
    ...
    columnMetrics?: HighchartsColumnMetricsObject;
    ...
    area?: any;
    id: string;
    userOptions: HighchartsSeriesOptions;
}
...
declare var HighchartsAdapter: HighchartsAdapterStatic;
interface HighchartsAdapterStatic{
    fireEvent(obj:any, func:string, params:any);
    stop(elem:any);
}
