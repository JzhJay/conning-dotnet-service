...
import { waitCondition, sleep } from 'utility';
import { IO } from 'stores/io';
import {waitChartFrontierData} from './ioTestUtils';

export function runStatisticalDominanceTests(getEnzymeContainer, getIo, expect) {
    ...
    describe(`Should show lambda statistical dominance`, function () {
    ...
    describe(`Should show efficient frontier statistical dominance`, function () {
        before(async function() {
          let io:IO = getIo();
          ...
          allocationsButton.simulate('click');
	        await waitChartFrontierData(io, "statisticalDominance", updateCount, true);
        });
    ...
    describe(`Should show statistical dominance percentages`, function () {
        before(async function() {
          let io:IO = getIo();
          let updateCount = io.updateCount;
