        ...
        (function (finance) {
            ...
            var FinancialSeries = /** @class */ (function (_super) {
                ...
                Object.defineProperty(FinancialSeries.prototype, "chartType", {
                    ...
                    set: function (value) {
                        value = wijmo.asEnum(value, finance.FinancialChartType, true);
                 ...
                 */
                FinancialSeries.prototype.getDataRect = function (currentRect, calculatedRect) {
                    if (calculatedRect) {
                        return calculatedRect;
                    }
                    var values = this.getValues(0), xvalues = this.getValues(1) || (this.chart._xvals && this.chart._xvals.length ? this.chart._xvals : null), bndHigh = this._getBinding(0), bndLow = this._getBinding(1), bndOpen = this._getBinding(2), bndClose = this._getBinding(3);
                    var plotter = this._plotter, type = this._getChartType() || this.chart._getChartType();
        ...
        (function (finance) {
            ...
            var _BaseRangePlotter = /** @class */ (function (_super) {
                ...
                _BaseRangePlotter.prototype._getDataPoint = function (seriesIndex, pointIndex, series, dataY) {
                    var x = pointIndex, dpt = new wijmo.chart._DataPoint(seriesIndex, pointIndex, x, dataY), item = series._getItem(this._rangeValues[pointIndex].pointIndex), bndX = series.bindingX || this.chart.bindingX, bndHigh = series._getBinding(0), bndLow = series._getBinding(1), bndOpen = series._getBinding(2), bndClose = series._getBinding(3), ay = series._getAxisY();
            ...
            var _PointAndFigurePlotter = /** @class */ (function (_super) {
                ...
                _PointAndFigurePlotter.prototype.renderData = function (chart, engine, data, boxSize) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var pt1 = new wijmo.Point(i - 0.5, item.min);
                        pt1 = chart.dataToPoint(pt1);
                        var pt2 = new wijmo.Point(i + 0.5, item.max);
                        pt2 = chart.dataToPoint(pt2);
                        ...
                        for (var j = 0; j < nsym + 1; j++) {
                            ...
                            if (this.hitTester) {
                                ...
                                var dpt = new wijmo.chart._DataPoint(si, i, item.date, y);
                                dpt["y"] = y;
                                ...
                                var ra = new wijmo.chart._RectArea(rect);
                                ra.tag = dpt;
        ...
        (function (finance) {
            ...
            var _HeikinAshiPlotter = /** @class */ (function (_super) {
                ...
                _HeikinAshiPlotter.prototype.plotSeries = function (engine, ax, ay, series, palette, iser, nser) {
                    var _this = this;
                    this._calculate(series);
                    var ser = wijmo.asType(series, wijmo.chart.SeriesBase), si = this.chart.series.indexOf(series), xs = series.getValues(1), sw = this._symFactor;
                ...
                _HeikinAshiPlotter.prototype._getDataPoint = function (seriesIndex, pointIndex, x, series) {
                    var dpt = new wijmo.chart._DataPoint(seriesIndex, pointIndex, x, this._haValues[pointIndex].high), item = series._getItem(pointIndex), bndHigh = series._getBinding(0), bndLow = series._getBinding(1), bndOpen = series._getBinding(2), bndClose = series._getBinding(3), ay = series._getAxisY();
    ...
    (function (chart) {
        ...
        (function (finance) {
            ...
            var FinancialChart = /** @class */ (function (_super) {
                ...
                FinancialChart.prototype._getProductInfo = function () {
