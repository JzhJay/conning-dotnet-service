        ...
        (function (interaction) {
            ...
            var ChartGestures = /** @class */ (function () {
                ...
                ChartGestures.prototype._panningChart = function (distanceX, distanceY) {
                    ...
                    var dx = axisX.reversed ? -distanceX : distanceX;
                    // check x axis range
                    ...
                    var dy = axisY.reversed ? -distanceY : distanceY;
                    // check y axis range
                ...
                ChartGestures.prototype._updateAxisByDistance = function (isX, distance) {
                    ...
                    var d = axis.reversed ? -distance : distance;
                    if ((d > 0 && oriMin === min) || (d < 0 && oriMax === max)) {
...
(function (wijmo) {
    ...
    (function (chart_2) {
        ...
        })(interaction = chart_2.interaction || (chart_2.interaction = {}));
    })(chart = wijmo.chart || (wijmo.chart = {}));
})(wijmo || (wijmo = {}));
(function (wijmo) {
    var chart;
    (function (chart_3) {
            ...
            */
            ...
            var RangeSelector = /** @class */ (function () {
                ...
                RangeSelector.prototype._adjustMinAndMax = function () {
                    ...
                    if (plotRect) {
                        var minPos = void 0, maxPos = void 0;
        ...
        })(interaction = chart_3.interaction || (chart_3.interaction = {}));
    })(chart = wijmo.chart || (wijmo.chart = {}));
})(wijmo || (wijmo = {}));
(function (wijmo) {
    var chart;
    (function (chart) {
        ...
        })(interaction = chart.interaction || (chart.interaction = {}));
    })(chart = wijmo.chart || (wijmo.chart = {}));
})(wijmo || (wijmo = {}));
