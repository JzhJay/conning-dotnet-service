    ...
    (function (chart) {
        ...
        (function (render) {
            ...
            var _CanvasRenderEngine = /** @class */ (function () {
                ...
                Object.defineProperty(_CanvasRenderEngine.prototype, "cssPriority", {
                    get: function () {
                ...
                Object.defineProperty(_CanvasRenderEngine.prototype, "readOnly", {
                    get: function () {
                ...
                _CanvasRenderEngine.prototype.drawLines = function (xs, ys, className, style, clipPath, num) {
                    if (!xs || !ys || xs.length === 0 || ys.length === 0 || this.readOnly) {
                        return;
                    }
                    var ctx = this._canvas.getContext('2d'), len = num ? num : Math.min(xs.length, ys.length), el, i;
                    if (this._applyCSSStyles) {
                ...
                _CanvasRenderEngine.prototype.drawSplines = function (xs, ys, className, style, clipPath, num) {
                    if (!xs || !ys || xs.length === 0 || ys.length === 0 || this.readOnly) {
                        return;
                    }
                    var ctx = this._canvas.getContext('2d'), spline = new wijmo.chart._Spline(xs, ys, num), s = spline.calculate(), sx = s.xs, sy = s.ys, len = Math.min(sx.length, sy.length), el, i;
                    if (this._applyCSSStyles) {
            ...
            if (wijmo.chart.FlexChartBase && wijmo.chart.FlexChartBase.prototype && wijmo.chart.FlexChartBase.prototype._exportToImage) {
                ...
                wijmo.chart.FlexChartBase.prototype._exportToImage = function (extension, processDataURI) {
                    ...
                    //fill background
                    var bg = this._bgColor(this.hostElement);
