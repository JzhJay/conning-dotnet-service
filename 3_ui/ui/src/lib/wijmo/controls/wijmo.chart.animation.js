...
(function (wijmo) {
    ...
    (function (chart) {
        var animation;
        (function (animation) {
            function softFinancial() {
                return wijmo._getModule('wijmo.chart.finance');
            }
            animation.softFinancial = softFinancial;
            function softRadar() {
                return wijmo._getModule('wijmo.chart.radar');
            }
            animation.softRadar = softRadar;
        })(animation = chart.animation || (chart.animation = {}));
    ...
    (function (chart_1) {
        ...
        (function (animation_1) {
            ...
            var ChartAnimation = /** @class */ (function () {
                ...
                function ChartAnimation(chart, options) {
                    ...
                    if (chart instanceof wijmo.chart.FlexPie) {
                        ...
                        if (animation_1.softRadar() && chart instanceof animation_1.softRadar().FlexRadar) {
                ...
                ChartAnimation.prototype._playAnimation = function () {
                    ...
                    if (self._play) {
                        self._animation.playAnimation(function () { return self.ended.raise(self, wijmo.EventArgs.empty); });
                    }
                    else {
                        self._play = true;
                    }
            ...
            var FlexAnimation = /** @class */ (function () {
                ...
                FlexAnimation.prototype.playAnimation = function (ended) {
                };
                ...
                FlexAnimation.prototype._playAnimation = function (animations, ended) {
                    var _this = this;
            ...
            var FlexPieAnimation = /** @class */ (function (_super) {
                ...
                FlexPieAnimation.prototype.playAnimation = function (ended) {
                    _super.prototype.playAnimation.call(this, ended);
            ...
            var FlexChartAnimation = /** @class */ (function (_super) {
                ...
                FlexChartAnimation.prototype.playAnimation = function (ended) {
                    _super.prototype.playAnimation.call(this, ended);
                    var self = this, isLoad = true, chart = self._chart, isFinancial = animation_1.softFinancial() && chart instanceof animation_1.softFinancial().FinancialChart, series = chart.series, len = series.length, i, s, chartType, seriesType, prevLen, prevState, prevXVal, currXVal, prev, animations = [];
                    self._previousState = self._currentState;
                ...
                FlexChartAnimation.prototype._convertAxisAnimation = function (animations, state, axis, maxValue, minValue) {
                    var _this = this;
                    var host = axis.hostElement, animation, isVert = axis.axisType == wijmo.chart.AxisType.Y;
                ...
                FlexChartAnimation.prototype._parseAxisState = function (axisState) {
                    ...
                    var vals = axisState.vals, axis = axisState.axis, isVert = axis.axisType == wijmo.chart.AxisType.Y, ele = axisState.ele, eles = ele.childNodes, eleIdx = 0, majorStates = [], minorStates = [];
                    var majors, minors, lbls;
                    if (vals) {
                        majors = vals.major;
                        minors = vals.minor;
                        lbls = vals.hasLbls;
