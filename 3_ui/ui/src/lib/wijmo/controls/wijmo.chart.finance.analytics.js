            ...
            (function (analytics) {
                ...
                var Fibonacci = /** @class */ (function (_super) {
                    ...
                    function Fibonacci(options) {
                        ...
                        _this._uptrend = true;
                        _this._labelPosition = wijmo.chart.LabelPosition.Left;
                ...
                var FibonacciArcs = /** @class */ (function (_super) {
                    ...
                    function FibonacciArcs(options) {
                        ...
                        _this._labelPosition = wijmo.chart.LabelPosition.Top;
                    ...
                    FibonacciArcs.prototype._render = function (sender, args) {
                        ...
                        var ax = this._getAxisX(), ay = this._getAxisY(), engine = args.engine, swidth = 2, group, si = this.chart.series.indexOf(this), stroke = this._getSymbolStroke(si), lstyle = wijmo.chart._BasePlotter.cloneStyle(this.style, ["fill"]), tstyle = wijmo.chart._BasePlotter.cloneStyle(this.style, ["stroke"]);
                ...
                var FibonacciFans = /** @class */ (function (_super) {
                    ...
                    FibonacciFans.prototype._render = function (sender, args) {
                        ...
                        var ax = this._getAxisX(), ay = this._getAxisY(), si = this.chart.series.indexOf(this), engine = args.engine, swidth = 2, stroke = this._getSymbolStroke(si), lstyle = wijmo.chart._BasePlotter.cloneStyle(this.style, ["fill"]), tstyle = wijmo.chart._BasePlotter.cloneStyle(this.style, ["stroke"]);
                        engine.stroke = stroke;
                        engine.strokeWidth = swidth;
                        engine.textFill = stroke;
                ...
                var FibonacciTimeZones = /** @class */ (function (_super) {
                    ...
                    function FibonacciTimeZones(options) {
                        ...
                        _this._labelPosition = wijmo.chart.LabelPosition.Right;
                        _this.rendering.addHandler(_this._render, _this);
                        _this.initialize(options);
                        return _this;
                    }
                    ...
                    FibonacciTimeZones.prototype._render = function (sender, args) {
                        ...
                        var diff = end - start, ax = this._getAxisX(), ay = this._getAxisY(), si = this._chart.series.indexOf(this), engine = args.engine, swidth = 2, stroke = this._getSymbolStroke(si), lstyle = wijmo.chart._BasePlotter.cloneStyle(this.style, ["fill"]), tstyle = wijmo.chart._BasePlotter.cloneStyle(this.style, ["stroke"]), ymin = ay.convert(ay.actualMin), ymax = ay.convert(ay.actualMax), lvl, x, size, lbl, clipPath = this.chart._plotrectId;
            ...
            (function (analytics) {
                ...
                var SingleOverlayIndicatorBase = /** @class */ (function (_super) {
                    ...
                    SingleOverlayIndicatorBase.prototype.getDataRect = function (currentRect, calculatedRect) {
                        ...
                        var xmin = wijmo.chart.finance._minimum(this._xvals), xmax = wijmo.chart.finance._maximum(this._xvals), ymin = wijmo.chart.finance._minimum(this._yvals), ymax = wijmo.chart.finance._maximum(this._yvals);
                    ...
                    SingleOverlayIndicatorBase.prototype._getItem = function (pointIndex) {
                        ...
                        var originalLen = _super.prototype._getLength.call(this), len = wijmo.chart.finance._minimum(this._yvals.length, this._xvals.length);
                        // data index
        ...
        (function (finance) {
            ...
            (function (analytics) {
                ...
                function _williamsR(highs, lows, closes, period) {
                    ...
                    var len = wijmo.chart.finance._minimum(highs.length, lows.length, closes.length), extremeHighs = [], extremeLows = [], williamsRs = [], i;
            ...
            (function (analytics) {
                ...
                var Stochastic = /** @class */ (function (_super) {
                    ...
                    Stochastic.prototype.getDataRect = function (currentRect, calculatedRect) {
                        ...
                        var ys = this._kVals.concat(this._dVals), xs = this._kXVals.concat(this._dXVals), xmin = wijmo.chart.finance._minimum(xs), xmax = wijmo.chart.finance._maximum(xs), ymin = wijmo.chart.finance._minimum(ys), ymax = wijmo.chart.finance._maximum(ys);
                        if (wijmo.chart._DataInfo.isValid(xmin) && wijmo.chart._DataInfo.isValid(xmax) && wijmo.chart._DataInfo.isValid(ymin) && wijmo.chart._DataInfo.isValid(ymax)) {
                            rect = new wijmo.Rect(xmin, ymin, xmax - xmin, ymax - ymin);
                        }
                        return rect;
        ...
        (function (finance) {
            ...
            (function (analytics) {
                ...
                var Macd = /** @class */ (function (_super) {
                    ...
                    /* overrides for multiple legend items */
                    Macd.prototype.legendItemLength = function () {
                    ...
                    Macd.prototype.getDataRect = function (currentRect, calculatedRect) {
                        ...
                        var xmin = wijmo.chart.finance._minimum(xs), xmax = wijmo.chart.finance._maximum(xs), ymin = wijmo.chart.finance._minimum(ys), ymax = wijmo.chart.finance._maximum(ys);
                        if (wijmo.chart._DataInfo.isValid(xmin) && wijmo.chart._DataInfo.isValid(xmax) && wijmo.chart._DataInfo.isValid(ymin) && wijmo.chart._DataInfo.isValid(ymax)) {
                            rect = new wijmo.Rect(xmin, ymin, xmax - xmin, ymax - ymin);
                        }
                        return rect;
                ...
                var MacdHistogram = /** @class */ (function (_super) {
                    ...
                    MacdHistogram.prototype.getDataRect = function (currentRect, calculatedRect) {
                        ...
                        var xmin = wijmo.chart.finance._minimum(this._histogramXVals), xmax = wijmo.chart.finance._maximum(this._histogramXVals), ymin = wijmo.chart.finance._minimum(this._histogramVals), ymax = wijmo.chart.finance._maximum(this._histogramVals);
                        if (wijmo.chart._DataInfo.isValid(xmin) && wijmo.chart._DataInfo.isValid(xmax) && wijmo.chart._DataInfo.isValid(ymin) && wijmo.chart._DataInfo.isValid(ymax)) {
                            rect = new wijmo.Rect(xmin, ymin, xmax - xmin, ymax - ymin);
                        }
                        return rect;
                    ...
                    MacdHistogram.prototype._getItem = function (pointIndex) {
                        var originalLen = _super.prototype._getLength.call(this), len = wijmo.chart.finance._minimum(this._histogramVals.length, this._histogramXVals.length);
                        // data index
                        pointIndex = originalLen - len + pointIndex;
                        return _super.prototype._getItem.call(this, pointIndex);
                    };
                ...
                function _macd(ys, fastPeriod, slowPeriod, smoothingPeriod) {
                    ...
                    var fastEmas = wijmo.chart.finance._ema(ys, fastPeriod), slowEmas = wijmo.chart.finance._ema(ys, slowPeriod), macds = [], histograms = [], signals, i;
            ...
            (function (analytics) {
                ...
                var Envelopes = /** @class */ (function (_super) {
                    ...
                    Envelopes.prototype.getDataRect = function (currentRect, calculatedRect) {
                        ...
                        var ys = this._upperYVals.concat(this._lowerYVals), xmin = wijmo.chart.finance._minimum(this._xVals), xmax = wijmo.chart.finance._maximum(this._xVals), ymin = wijmo.chart.finance._minimum(ys), ymax = wijmo.chart.finance._maximum(ys);
                        if (wijmo.chart._DataInfo.isValid(xmin) && wijmo.chart._DataInfo.isValid(xmax) && wijmo.chart._DataInfo.isValid(ymin) && wijmo.chart._DataInfo.isValid(ymax)) {
                            rect = new wijmo.Rect(xmin, ymin, xmax - xmin, ymax - ymin);
                        }
                        return rect;
                    ...
                    Envelopes.prototype._calculate = function () {
                        ...
                        this._xVals = xs ? xs.slice(this.period - 1) : wijmo.chart.finance._range(this.period - 1, _super.prototype._getLength.call(this) - 1);
                    ...
                    Envelopes.prototype._rendering = function (sender, args) {
                        ...
                        var si = this.chart.series.indexOf(this), engine = args.engine, ax = this._getAxisX(), ay = this._getAxisY(), len = wijmo.chart.finance._minimum(this._upperYVals.length, this._lowerYVals.length, this._xVals.length), style = wijmo.chart._BasePlotter.cloneStyle(this.style, ["fill"]), stroke = this._getSymbolStroke(si), clipPath = this.chart._plotrectId, swidth = 2;
                        if (!len || len <= 0) {
                            return;
                        }
                        engine.stroke = stroke;
        ...
        (function (finance) {
            ...
            (function (analytics) {
                ...
                function _cci(highs, lows, closes, period, constant) {
                    ...
                    var len = wijmo.chart.finance._minimum(highs.length, lows.length, closes.length), typicalPrices = [], meanDeviations = [], smas, i, ccis = [];
            ...
            (function (analytics) {
                ...
                var BollingerBands = /** @class */ (function (_super) {
                    ...
                    BollingerBands.prototype._rendering = function (sender, args) {
                        ...
                        var si = this.chart.series.indexOf(this), engine = args.engine, ax = this._getAxisX(), ay = this._getAxisY(), len = wijmo.chart.finance._minimum(this._upperYVals.length, this._middleYVals.length, this._lowerYVals.length, this._xVals.length), style = wijmo.chart._BasePlotter.cloneStyle(this.style, ["fill"]), stroke = this._getSymbolStroke(si), clipPath = this.chart._plotrectId, swidth = 2;
                        if (!len || len <= 0) {
                            return;
                        }
                        engine.stroke = stroke;
                ...
                function _bollingerBands(ys, period, multiplier) {
                    ...
                    var avgs = wijmo.chart.finance._sma(ys, period), devs = [], i;
