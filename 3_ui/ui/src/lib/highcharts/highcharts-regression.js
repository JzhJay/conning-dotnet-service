...
module.exports = (function (H) {
    ...
    H.wrap(H.Chart.prototype, 'init', function (proceed) {
        ...
        for (i = 0 ; i < series.length ; i++){
            ...
            if ( s.regression && !s.rendered ) {
                ...
                s.regressionSettings.decimalPlaces = s.regressionSettings.decimalPlaces || 5;
                ...
                var extraSerie = {
                    ...
                    name: s.regressionSettings.name || "%eq (R² = %r2)",
                ...
                if (parseFloat(regression.rSquared) == 0)
                    regression.rSquared = 0;
                else if (!Number.isFinite(parseFloat(regression.rSquared)) || _.uniqBy(s.data, (d) => [d.x, d.y].join()).length === 1) {
                    regression.rSquared = "N/A";
                    extraSerie.name = "N/A";
                }
                ...
                extraSerie.visible = s.regressionSettings.visible;
                extraSerie.showInLegend = s.regressionSettings.showInLegend;
    ...
    function _linear(data, decimalPlaces) {
        ...
        var string = 'y = ' + intercept.toPrecision(decimalPlaces) + " + " + Math.round(gradient*10000) / 10000 + 'x';
            //Math.round(intercept*10000) / 10000;
