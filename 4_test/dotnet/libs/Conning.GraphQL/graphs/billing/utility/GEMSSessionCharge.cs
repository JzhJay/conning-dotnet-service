...
{
    public class RSSimulationSessionCharge
    {
        ...
        public RSSimulationSessionCharge(DateTime sessionStartTime, DateTime sessionEndTime, DateTime deleteTime, string userId)
        {
